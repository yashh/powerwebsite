const paragraphs = [
    {
        ...
        highlights: [
            { start: 11, end: 23, className: "highlight-1" }
        ]
    },
    {
        text: "Credit card issuers take over $150 billion yearly using BANK TO FEES TO BANK transfers.",
        highlights: [
            { start: 56, end: 76, className: "highlight-2" },
        ]
    },
    {
        text: "They call them interchange fees ... We call them a clever way to make you pay more for the same stuff while giving you “rewards.” Because who wouldn’t want cash back on the 2.5% they just squeezed out of your payment? ",
        highlights: []
    },
    {
        text: "Wouldn’t it be nice if your money was ... yours?",
        highlights: [
            { start: 42, end: 49, link: "https://www.threads.net/@nowthisimpact/post/DCpsFaNK9EB?xmt=AQGzcWVzNw6ZdA2-pJFsVGDffyC8lwgOu6XX7qLCoiHE9Q", className: "yours-link" }
        ]
    }
];
    ...
    return new Promise((resolve) => {
        ...
        highlights.forEach(h => {
            ...
            if (h.start > lastIndex) {
                elements.push({ type: "text", content: text.slice(lastIndex, h.start) });
            }
